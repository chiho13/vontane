...
import { EditorProvider, SlateEditorProvider } from "@/contexts/EditorContext";
...
export const WorkspaceContainer: React.FC<WorkspaceProps> = memo(
  ({ workspaceId }) => {
        ...
        >
          <NewColumnProvider>
            {!fetchWorkspaceIsLoading && initialSlateValue && workspaceId && (
              <SlateEditorProvider key={workspaceId}>
