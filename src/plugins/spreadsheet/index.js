...
function evaluate(formula, point, formulaParser) {
  try {
    ...
    return returned instanceof FormulaParser.FormulaError
      ? returned.toString()
      : returned;
  } catch (error) {
    if (error instanceof FormulaParser.FormulaError) {
...
function evaluateCell(
  ...
  if (referenceGraph.hasCircularDependency(point)) {
    ...
    var nextEvaluatedData_1 = set(
      point,
      __assign(__assign({}, cell), { value: FormulaParser.FormulaError.REF }),
      prevEvaluatedData
    );
    try {
      for (
        ...
        nextEvaluatedData_1 = set(
          referrer,
          __assign(__assign({}, referrerCell), {
            value: FormulaParser.FormulaError.REF,
          }),
          nextEvaluatedData_1
        );
      }
...
var Table = function (_a) {
  ...
  var columnNodes = range(columnCount).map(function (i) {
    return React__namespace.createElement("col", { key: i });
  });
...
var Row = function (props) {
  return React__namespace.createElement("tr", __assign({}, props));
};
...
var CornerIndicator = function (_a) {
  ...
  var handleClick = React__namespace.useCallback(
    function () {
      onSelect();
    },
    [onSelect]
...
var enhance$3 = function (CornerIndicatorComponent) {
  return function CornerIndicatorWrapper(props) {
    ...
    var selectEntireWorksheet$1 = React__namespace.useCallback(
      function () {
...
var enhance$2 = function (ColumnIndicatorComponent) {
  return function ColumnIndicatorWrapper(props) {
    var dispatch = useDispatch();
    var selectEntireColumn$1 = React__namespace.useCallback(
...
var enhance$1 = function (RowIndicatorComponent) {
  return function RowIndicatorWrapper(props) {
    ...
    var selectEntireRow$1 = React__namespace.useCallback(
      function (row, extend) {
...
var Cell = function (_a) {
  ...
  var point = React__namespace.useMemo(
    function () {
      return {
        row: row,
        column: column,
  ...
  var handleMouseDown = React__namespace.useCallback(
    function (event) {
      if (mode === "view") {
  ...
  var handleMouseOver = React__namespace.useCallback(
    function (event) {
      if (dragging) {
        setCellDimensions(point, getOffsetRect(event.currentTarget));
        select(point);
  ...
  return React__namespace.createElement(
    ...
    React__namespace.createElement(DataViewer, {
      row: row,
      column: column,
      cell: data,
...
var enhance = function (CellComponent) {
  return function CellWrapper(props) {
    ...
    var setCellData$1 = React__namespace.useCallback(
      function (data) {
        return dispatch(setCellData(point, data));
      },
      [dispatch, point]
    );
    var select$1 = React__namespace.useCallback(
      function (point) {
        return dispatch(select(point));
      },
      [dispatch]
    );
    var activate$1 = React__namespace.useCallback(
      function (point) {
        return dispatch(activate(point));
      },
      [dispatch]
    );
    var setCellDimensions$1 = React__namespace.useCallback(
...
var DataEditor = function (_a) {
  ...
  var handleChange = React__namespace.useCallback(
    function (event) {
...
var ActiveCell = function (props) {
  ...
  var edit = React__namespace.useCallback(
    function () {
      return dispatch(edit$1());
    },
    [dispatch]
  );
  var commit = React__namespace.useCallback(
    function (changes) {
      return dispatch(commit$1(changes));
    },
    [dispatch]
  );
  var view = React__namespace.useCallback(
    function () {
      dispatch(view$1());
    },
    [dispatch]
  ...
  var hidden = React__namespace.useMemo(
    function () {
  ...
  return hidden
    ...
    : React__namespace.createElement(
        ...
        mode === "edit" &&
          active &&
          React__namespace.createElement(DataEditor, {
            row: active.row,
...
var Selected = function () {
  ...
  return React__namespace.createElement(FloatingRect, {
    variant: "selected",
...
var Spreadsheet = function (props) {
  ...
  var initialState = React__namespace.useMemo(
    function () {
  ...
  var _m = __read(reducerElements, 2),
    state = _m[0],
    dispatch = _m[1];
  var size = React__namespace.useMemo(
    function () {
  ...
  var mode = state.mode;
  var rootRef = React__namespace.useRef(null);
  var copy$1 = React__namespace.useCallback(
    function () {
      return dispatch(copy());
    },
    [dispatch]
  );
  var cut$1 = React__namespace.useCallback(
    function () {
      return dispatch(cut());
    },
    [dispatch]
  );
  var paste$1 = React__namespace.useCallback(
    function (data) {
      return dispatch(paste(data));
    },
    [dispatch]
  );
  var onKeyDownAction = React__namespace.useCallback(
    function (event) {
      return dispatch(keyDown(event));
    },
    [dispatch]
  );
  var onKeyPress = React__namespace.useCallback(
    function (event) {
      return dispatch(keyPress(event));
    },
    [dispatch]
  );
  var onDragStart = React__namespace.useCallback(
    function () {
      return dispatch(dragStart());
    },
    [dispatch]
  );
  var onDragEnd = React__namespace.useCallback(
    function () {
      return dispatch(dragEnd());
    },
    [dispatch]
  );
  var setData$1 = React__namespace.useCallback(
    function (data) {
      return dispatch(setData(data));
    },
    [dispatch]
  );
  var setCreateFormulaParser$1 = React__namespace.useCallback(
    function (createFormulaParser) {
      return dispatch(setCreateFormulaParser(createFormulaParser));
    },
    [dispatch]
  );
  var blur = React__namespace.useCallback(
    function () {
      return dispatch(blur$1());
    },
    [dispatch]
  );
  var setSelection$1 = React__namespace.useCallback(
    function (selection) {
  ...
  var prevCreateFormulaParserPropRef = React__namespace.useRef(
  ...
  var writeDataToClipboard = React__namespace.useCallback(
    function (event) {
  ...
  var handleCut = React__namespace.useCallback(
    function (event) {
  ...
  var handleCopy = React__namespace.useCallback(
    function (event) {
      if (shouldHandleClipboardEvent(rootRef.current, mode)) {
        event.preventDefault();
        event.stopPropagation();
  ...
  var handlePaste = React__namespace.useCallback(
    function (event) {
      if (shouldHandleClipboardEvent(rootRef.current, mode)) {
        event.preventDefault();
        event.stopPropagation();
  ...
  var handleKeyDown = React__namespace.useCallback(
    function (event) {
      event.persist();
      if (onKeyDown) {
        onKeyDown(event);
  ...
  var handleMouseUp = React__namespace.useCallback(
    function () {
      onDragEnd();
  ...
  var handleMouseMove = React__namespace.useCallback(
    function (event) {
  ...
  var handleBlur = React__namespace.useCallback(
    function (event) {
      /**
  ...
  var Cell$1 = React__namespace.useMemo(
    function () {
      // @ts-ignore
  ...
  var CornerIndicator$1 = React__namespace.useMemo(
    function () {
      return enhance$3(props.CornerIndicator || CornerIndicator);
    },
    [props.CornerIndicator]
  );
  var RowIndicator$1 = React__namespace.useMemo(
    function () {
      return enhance$1(props.RowIndicator || RowIndicator);
    },
    [props.RowIndicator]
  );
  var ColumnIndicator$1 = React__namespace.useMemo(
    function () {
  ...
  var tableNode = React__namespace.useMemo(
    function () {
      return React__namespace.createElement(
        Table$1,
        ...
        React__namespace.createElement(
          ...
          !hideRowIndicators &&
            ...
            React__namespace.createElement(CornerIndicator$1, null),
          !hideColumnIndicators &&
            range(size.columns).map(function (columnNumber) {
              return columnLabels
                ? React__namespace.createElement(ColumnIndicator$1, {
                    key: columnNumber,
                    column: columnNumber,
                    label:
        ...
        range(size.rows).map(function (rowNumber) {
          return React__namespace.createElement(
            ...
            !hideRowIndicators &&
              (rowLabels
                ? React__namespace.createElement(RowIndicator$1, {
                    key: rowNumber,
                    row: rowNumber,
  ...
  var activeCellNode = React__namespace.useMemo(
    function () {
      return React__namespace.createElement(
        ActiveCell,
        // @ts-ignore
  ...
  var rootNode = React__namespace.useMemo(
    function () {
      return React__namespace.createElement(
        "div",
        {
